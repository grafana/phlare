...
func NewFilePCLNData(f *os.File, offset int) *FilePCLNData {
	return &FilePCLNData{
		...
		//file: NewBufferedReaderAt(f, 1*1024*1024),
		//file:   f,
		offset: offset,
...
//func NewBufferedReaderAt(f io.ReaderAt, sz int) io.ReaderAt {
//	return &BufferedReaderAt{f: f, buf: make([]byte, sz), offset: -1}
//}
