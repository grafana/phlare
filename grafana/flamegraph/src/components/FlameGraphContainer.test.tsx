...
describe('FlameGraphContainer', () => {
  ...
  it('search should highlight matching results', async () => {
    ...
    expect(screen.getByTestId('flamegraph').children[0].getAttribute('style')).toContain('background: rgb(255, 112, 112)');
    ...
    expect(screen.getByTestId('flamegraph').children[0].getAttribute('style')).toContain('background: rgb(222, 218, 247)'); // greyed out as not a result
    ...
    expect(screen.getByTestId('flamegraph').children[4].getAttribute('style')).toContain('background: rgb(222, 218, 247)'); // greyed out as not a result
