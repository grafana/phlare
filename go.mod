...
replace (
	github.com/parca-dev/parca => github.com/cyriltovena/parca v0.11.1-0.20220706063852-616bc454eae4
	github.com/polarsignals/frostdb => github.com/grafana/frostdb v0.0.0-20220705195041-7702c3e130fd
